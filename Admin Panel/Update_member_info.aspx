<%@ Page Title="" Language="C#" MasterPageFile="~/Admin Panel/Main_Master.Master" AutoEventWireup="true" CodeBehind="Update_member_info.aspx.cs" Inherits="GYM_4._1.Admin_Panel.Update_Member_Info" %>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Update Member Profile</h4>
                  <p class="card-category">Complete Updation of Member Profile</p>
                </div>
                <div class="card-body">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">Date Of Join<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="tbDOJ" ForeColor="Red"></asp:RequiredFieldValidator></label>
                          <asp:TextBox ID="tbDOJ" runat="server" class="form-control" ReadOnly="True"></asp:TextBox>
                        
                        </div>
                        
                        <div class="form-group">
                          <label class="bmd-label-floating">Plan expired<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="tbPlan_expired" ForeColor="Red"></asp:RequiredFieldValidator></label>
                          <asp:TextBox ID="tbPlan_expired" runat="server" class="form-control" placeholder="Membership expiry date" ></asp:TextBox>
                        </div>
                    ...
                    <div>
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnUpdate" class="btn btn-danger" runat="server" Text="Submit" OnClick="btnUpdate_Click" />
                    </div>
              </div>
              </div>
            </div>
